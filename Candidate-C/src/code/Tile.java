...
public class Tile {
	...
	private Player _player;//geting the name of the player that owns the meepe
	...
	public void setFollowerSpot(int _followerSpot, Player s) {
		_player =s;
	...
	/**
	 * @return ArrayList of features that are occupied by a follower on the tile
	 */
	 ...
	 * @return	Return true is feature is occupied by a Follower (in the OccupiedFeatures Array)
	 */
	public boolean isFeatureOccupied(int i) {
		return _occupiedFeatures.contains(i);
	}

	public void distributeOccupiedFeatures(int i){
		// how to do this?? 
		// Find feature "string" associated with the location i 
		// 
	}

	/**
	 * @param i  Adds a feature at location i on tile to OccupiedFeatures array 
	 */
	...
	/**
	 * @return Returns the feature String at a specific location on the tile 
	 */
	...
	/**
	 * @return Returns an arrayList<Strings> of all features on tile ["field","field","field","field","Road",...]
	 */
	...
	/**
	 * @return returns array of the tile's coordinates on the board 
	 */
